...
import { CameraAlt as CameraAltIcon } from "@mui/icons-material";
import { useFileHandler, useInputValidation, useStrongPassword } from "6pp"; // Ensure this hook works as expected or manually handle file uploads
import { usernameValidator } from "../utils/validators";
...
const Login = () => {
  ...
  // Set the document title based on the current state
  useEffect(() => {
